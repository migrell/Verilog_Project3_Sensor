...
HD_PWD='C:/Users/kccistc/Desktop/250325_Verilog_Project3/250325_Uart_Sensor/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_distance_meter.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ultrasonic_distance_meter.tcl -notrace
