...
HD_PWD='C:/Users/kccistc/Desktop/250325_Verilog_Project3/250325_Uart_Sensor/project_1/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ultrasonic_distance_meter.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ultrasonic_distance_meter.tcl
