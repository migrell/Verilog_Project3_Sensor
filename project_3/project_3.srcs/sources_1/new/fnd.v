...
module decoder_3x8 (
    ...
    always @(seg_select) begin
        case (seg_select)
            ...
            3'b100:
            seg_comm = 4'b1110;  // 다섯 번째 자리 (첫 번째와 동일)
            3'b101:
            seg_comm = 4'b1101;  // 여섯 번째 자리 (두 번째와 동일)
            3'b110:
            seg_comm = 4'b1011;  // 일곱 번째 자리 (세 번째와 동일)
            3'b111:
            seg_comm = 4'b0111;  // 여덟 번째 자리 (네 번째와 동일)
